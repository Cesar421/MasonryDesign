...
IFontDisp = Font
__all__ = [ 'StdFont', 'Default', 'OLE_XPOS_PIXELS',
           'OLE_XPOS_HIMETRIC', 'OLE_XSIZE_HIMETRIC', 'VgaColor',
           'IFontEventsDisp', 'IPicture', 'FontEvents',
           'OLE_YSIZE_PIXELS', 'OLE_OPTEXCLUSIVE',
           'OLE_YSIZE_CONTAINER', 'Unchecked', 'OLE_XSIZE_PIXELS',
           'FONTUNDERSCORE', 'FONTSTRIKETHROUGH', 'OLE_TRISTATE',
           'OLE_YPOS_CONTAINER', 'OLE_XPOS_CONTAINER', 'OLE_HANDLE',
           'IPictureDisp', 'IFont', 'OLE_COLOR', 'Gray', 'Monochrome',
           'LoadPictureConstants', 'OLE_YPOS_PIXELS', 'FONTSIZE',
           'Checked', 'FONTNAME', 'StdPicture', 'FONTBOLD',
           'FONTITALIC', 'Picture', 'OLE_YSIZE_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'Font', 'Color',
